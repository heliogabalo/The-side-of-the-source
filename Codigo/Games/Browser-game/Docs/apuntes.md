> Hay que empezar a aislar las variables globales y meterlas en la función que toca. Hay que estudiar como acceder a ellas, > desde el ámbito adecuado(scope scope scope).
